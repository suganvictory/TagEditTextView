...
import com.tagedittextlibrary.R;
...
public class TagsEditText extends EditText {
    ...
    private void init(@Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (attrs == null) {
            ...
            mRightDrawable = ContextCompat.getDrawable(context, R.drawable.tag_closebtn);
    ...
    private void saveDatabyEnterKeyword(String source) {

        if (source.equalsIgnoreCase("\n")) {
            System.err.println("tags added by popup");
        } else {
            System.err.println("new tag added by enter click");
            SingletonLibrary.getInstance().arrayListKeys.add(source);
    ...
    private void removeTagSpan(Editable editable, TagSpan span, boolean includeSpace) {
        ...
        SingletonLibrary.getInstance().arrayListKeys.remove(tagIndex);
        SingletonLibrary.getInstance().stringArrKeys = new String[SingletonLibrary.getInstance().arrayListKeys.size()];
        SingletonLibrary.getInstance().stringArrKeys = SingletonLibrary.getInstance().arrayListKeys.toArray(SingletonLibrary.getInstance().stringArrKeys);
